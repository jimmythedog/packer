---
description: |
    This VMware Packer builder is able to create VMware virtual machines from a local ova/ovf file. It currently supports building
...
layout: docs
page_title: VMware Builder from OVA/OVF
...

# VMware Builder (from OVA/OVF)

Type: `vmware-ovf`

   This VMware Packer builder is able to create VMware virtual machines from a local [ova/ovf file](https://en.wikipedia.org/wiki/Open_Virtualization_Format). It currently supports building
...
The builder builds a virtual machine by using [ovftool](https://www.vmware.com/support/developer/ovf/)  to import the ova/ovf file.
After importing the file, it provisions software within the new machine,
shuts it down, and compacts the disks.

***Important! [ovftool](https://www.vmware.com/support/developer/ovf/) must be installed on the local machine!***
...
{
  "type": "vmware-vmx",
  "source_path": "/path/to/a/file.ova",
  "ssh_username": "root",
  "ssh_password": "root",
...
-   `source_path` (string) - Path to the source OVA/OVF file to import.
